...
replacedString = replaceMe.replace("John", "Micheal")
...
removedString = removeMe.replace("going to ", "").strip()
...
testString2= testString2.lower().replace("first sentence", "second best").replace("second sentence", "first best").replace(".", ",") + "!"
########################################################################
