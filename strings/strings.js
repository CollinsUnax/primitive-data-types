...
testString1= String(targetString1)
...
testString2= targetString2.toLowerCase().replace("first sentence", "second best")
          .replace("second sentence", "first best").replace(".", ",").replace("/$/", "!")
